...
image_path = "Destiny 2 Scripts/AFK Warlord's Ruin First Boss Farm"
...
def my_function():
    ...
    while True:
        if total_failed_attempts > 0 and total_failed_attempts % 10 == 10:
            ...
            while True:
                if pyautogui.locateOnScreen(f"{image_path}\Dungeon Mission Objective Icon.png", confidence=0.8):
                    break
            restart_dungeon()
        ...
        if pyautogui.locateOnScreen(f"{image_path}\Smoke Bomb.png", confidence=0.9):
            ...
            while True:
                ...
                if pyautogui.locateOnScreen(f"{image_path}\Guardian Down.png", confidence=0.8) or pyautogui.locateOnScreen("Your Light Fades Away.png", confidence=0.8):
                    print("Case: Guardian Down")
                    total_failed_attempts += 1
                    break

                elif not pyautogui.locateOnScreen(f"{image_path}\Boss Health Bar.png", confidence=0.7, region=(842, 1273, 500, 500)):
